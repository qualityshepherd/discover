...
export const getSiteStub = (req, env) => {
...
// template is the analytics admin HTML string — provided by each project's analytics.js
export async function handleAnalytics (req, env, hostname, template) {
  const url = new URL(req.url)
