...
test('classifyHit: decoded XSS probe with %3C is a bot', t => { t.is(classifyHit('/%3Cimg'), 'bot') })
test('classifyHit: decoded double-quote path injection is a bot', t => { t.is(classifyHit('/%22/discover/discover.js%22'), 'bot') })
